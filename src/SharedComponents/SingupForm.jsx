...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.userType && user.firstName && user.lastName && user.username && user.emailAddress && user.password && user.confirmPassword) {
        ...
        return (
            <div className="col-md-6 col-md-offset-3">
              ...
              <div className={'form-group' + (submitted && !user.userType ? ' has-error' : '')}>
                ...
                <select  type="text" className="form-control" name="userType" value={user.userType} onChange={this.handleChange} > 
                ...
                {submitted && !user.userType&&
                  <div className="help-block">PLease Select User Type</div>
                }
              </div>
              ...
              <div className={'form-group' + (submitted && !user.emailAddress ? ' has-error' : '')}>
                <input type="text" placeholder='Email Address' className="form-control" name="emailAddress" value={user.emailAddress} onChange={this.handleChange} />
              ...
              <div className={'form-group' + (submitted && !user.confirmPassword ? ' has-error' : '')}>
                <input placeholder='Confirm Password' type="confirmPassword" className="form-control" name="confirmPassword" value={user.confirmPassword} onChange={this.handleChange} />
